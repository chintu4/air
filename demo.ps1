#!/usr/bin/env pwsh
# Comprehensive demo of air capabilities

Write-Host "🤖 air - Advanced AI Agent Demo" -ForegroundColor Green
Write-Host "=================================" -ForegroundColor Green
Write-Host ""

Write-Host "This demo shows air's intelligent routing between local and cloud models." -ForegroundColor Cyan
